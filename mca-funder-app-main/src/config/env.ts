  ...
  api: {
    ...
    endpoints: {
      ...
      document: {
        ...
        previewDocument: '/documents/:documentId/preview',
        ...
        generateFromTemplate: '/documents/generate-from-template',
        initiateSignature: '/documents/:documentId/sign',
        getSignatureStatus: '/documents/:documentId/signature-status',
      },
      syndicator: {
      ...
      application: {
        ...
        getApplicationOfferDocuments: '/application-offers/:applicationId/documents',
        getApplicationOfferDocumentList: '/application-offers/:applicationId/documents/list',
        getApplicationOfferDocumentById: '/application-offers/:applicationId/documents/:documentId',
        createApplicationOfferDocument: '/application-offers/:applicationId/documents',
        updateApplicationOfferDocument: '/application-offers/:applicationId/documents/:documentId',
        checkApplicationOfferDocument: '/application-offers/:applicationId/documents/check/:documentId',
        deleteApplicationOfferDocument: '/application-offers/:applicationId/documents/:documentId',
        // stipulations
        ...
        // stipulations
        getApplicationOfferStipulations: '/application-offers/:applicationId/stipulations',
        getApplicationOfferStipulationList: '/application-offers/:applicationId/stipulations/list',
        getApplicationOfferStipulationById: '/application-offers/:applicationId/stipulations/:stipulationId',
        createApplicationOfferStipulation: '/application-offers/:applicationId/stipulations',
        updateApplicationOfferStipulation: '/application-offers/:applicationId/stipulations/:stipulationId',
        deleteApplicationOfferStipulation: '/application-offers/:applicationId/stipulations/:stipulationId',
        toggleApplicationOfferStipulation: '/application-offers/:applicationId/stipulations/:stipulationId/toggle',
      },
      applicationStatus: {
